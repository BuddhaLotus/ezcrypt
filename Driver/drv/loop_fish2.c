...
static DWORD32 mds_mul(UCHAR *y)		//Inline
{ DWORD32 z;
...
static DWORD32 f32(DWORD32 x, const DWORD32 * k32, int keyLen)
{
  UCHAR b[4];
  ...
  *((DWORD32 *) b) = Bswap(x);	/* make b[0] = LSB, b[3] = MSB */
